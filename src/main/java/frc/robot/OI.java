...
public final class OI {
  ...
  public static class XboxDriver implements DrivingConstants.DriverActionSet {
    ...
    public double forward() {
      return deadband(stick.getLeftY(), DrivingConstants.JOYSTICK_DEADBAND) * 0.3;
    }

    @Override
    public double strafe() {
      return deadband(stick.getLeftX(), DrivingConstants.JOYSTICK_DEADBAND) * 0.3;
    }

    @Override
    public double turn() {
      return deadband(stick.getRightX(), DrivingConstants.JOYSTICK_DEADBAND) * 0.3;
    }
